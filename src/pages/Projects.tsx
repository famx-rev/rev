...
function Projects() {
  ...
  const copyTrackingCode = (project: Project) => {
    const code = `<script src="https://api1-orpin.vercel.app/api/custom/${project.id}/tracking.js" defer></script>`;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-700 transition-colors"
          >
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-12 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">Create your first project to start tracking analytics.</p>
            <button
              onClick={() => setShowCreateModal(true)}
                  ...
                  <div className="p-6">
                    <div className="flex gap-4 mb-4">
                      <input
                        ...
                        className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-700 transition-colors"
                      >
                        Save
                      </button>
                    </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-3 text-sm text-gray-500 dark:text-gray-400">
                          ...
                          <span>Tracking ID: <code className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-2 py-0.5 rounded">{project.trackingId}</code></span>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                            selectedProject?.id === project.id
                              ...
                              : 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950/40 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/50'
                          }`}
                        ...
                        <button
                          ...
                          className="p-2 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 rounded-lg transition-colors"
                    ...
                    {selectedProject?.id === project.id && (
                      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Tracking Code</h4>
                        <div className="bg-gray-900 dark:bg-gray-800 text-gray-100 dark:text-gray-200 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                          <pre className="whitespace-pre-wrap text-xs">{`<script src="https://api1-orpin.vercel.app/api/custom/${project.id}/tracking.js" defer></script>`}</pre>
                        </div>
                        <button
                          onClick={() => copyTrackingCode(project)}
                          className="mt-3 flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-700 transition-colors"
                        >
                          {copiedId === project.id ? (
                            <>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  value={newProjectName}
                  onChange={(e) => setNewProjectName(e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400"
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                ...
                className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Create Project
              </button>
            </div>
